...
class ProductTagController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.productTags.create', compact('products', 'tags'));
    }
    ...
    public function edit(ProductTag $productTag)
    {
        ...
        $productTag->load('product', 'tag');

        return view('admin.productTags.edit', compact('productTag', 'products', 'tags'));
    }
