...
class HomeController
{
    ...
    ->count();
       ...
       // coupon stats
        ...
        return view('admin.home',compact('dashData','totalSale','totalOrders','deliverdOrders','pendingOrders','canceledOrders','recentOrders','bestSellingProduct','mostViewedProducts','contactUs','enquire','subscriptions','customers','customersTotal','products','salesbyCategory','recentReviews','startDate','endDate','processingOrders','shippedOrders','failedOrders','refundedOrders','totalCouponsIssued','couponsRedeemed','redemptionRate','averageSavingsPerCoupon','totalSavingsToCustomers','salesGenerated','topPerformingCoupons'))->with('i', (request()->input('page', 1) - 1) * 6);
    }
}
