...
class AuthMutator
{
    ...
    {
        return Shop::call('App\Http\Controllers\UserController@sendOtpCode', $args);
    }
    public function verifyOtpCode($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('App\Http\Controllers\UserController@verifyOtpCode', $args);
    }
    public function otpLogin($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('App\Http\Controllers\UserController@otpLogin', $args);
    }
    public function updateContact($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('App\Http\Controllers\UserController@updateContact', $args);
    }
    public function addPoints($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('App\Http\Controllers\UserController@addPoints', $args);
    }
    public function makeOrRevokeAdmin($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('App\Http\Controllers\UserController@makeOrRevokeAdmin', $args);
    }
    public function generateDownloadableUrl($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('App\Http\Controllers\UserController@generateDownloadableUrl', $args);
    }
    public function generateOrderExportUrl($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('App\Http\Controllers\OrderController@exportOrderUrl', $args);
    }

    public function subscribeToNewsletter($rootValue, array $args, GraphQLContext $context)
    {
        return Shop::call('App\Http\Controllers\UserController@subscribeToNewsletter', $args);
    }
}