...
trait TranslationTrait
{
    ...
    public function formatInvoiceTranslateText($translatedText = [])
    {
        return [
            ...
            'tax_rate'          => Arr::has($translatedText, 'tax_rate') ? $translatedText['tax_rate'] : 'Tax Rate',
            'tax_amount'          => Arr::has($translatedText, 'tax_amount') ? $translatedText['tax_amount'] : 'Tax Amount',
            'unit_price'          => Arr::has($translatedText, 'unit_price') ? $translatedText['unit_price'] : 'Unit Price',
            'price'          => Arr::has($translatedText, 'price') ? $translatedText['price'] : 'Price',
            'products_total'          => Arr::has($translatedText, 'products_total') ? $translatedText['products_total'] : 'Products Total',
        ];
    }
}
