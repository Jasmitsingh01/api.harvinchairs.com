...
use App\Database\Models\PaymentIntent;
...
trait PaymentTrait
{
    ...
    public function processPaymentIntent(Request $request, Settings $settings): object
    {
        ...
        return PaymentIntent::where('tracking_number', '=', $orderTrackingNumber)->where('payment_gateway', '=', strtoupper($settings->options['paymentGateway']))->first();
    }
