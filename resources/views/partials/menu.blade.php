<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
            ...
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.best-seller.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/best-seller") || request()->is("admin/best-seller/*") ? "c-active" : "" }}">
                    <i class="fa-light fa-star c-sidebar-nav-icon">
