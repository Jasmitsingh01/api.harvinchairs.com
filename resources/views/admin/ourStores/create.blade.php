...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ourStore.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.our-stores.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('short_line') ? 'is-invalid' : '' }}" type="text" name="short_line" id="short_line" value="{{ old('short_line', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('opening_hours') ? 'is-invalid' : '' }}" type="text" name="opening_hours" id="opening_hours" value="{{ old('opening_hours', '') }}">
