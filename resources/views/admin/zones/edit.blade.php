    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.zones.update", [$zone->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('Ship_Amt') ? 'is-invalid' : '' }}" type="number" name="Ship_Amt" id="Ship_Amt" value="{{ old('Ship_Amt', $zone->Ship_Amt) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('MinShip_Amt') ? 'is-invalid' : '' }}" type="number" name="MinShip_Amt" id="MinShip_Amt" value="{{ old('min_ship_amt', $zone->MinShip_Amt) }}" step="0.01">
                @if($errors->has('MinShip_Amt'))
                    <div class="invalid-feedback">
                        {{ $errors->first('MinShip_Amt') }}
                    </div>
                @endif
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('active') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="active" id="active" value="1" {{ $zone->active || old('active', 0) === 1 ? 'checked' : '' }}>
