    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.order-statuses.update", [$orderStatus->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $orderStatus->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('template') ? 'is-invalid' : '' }}" type="text" name="template" id="template" value="{{ old('template', $orderStatus->template) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('module_name') ? 'is-invalid' : '' }}" type="text" name="module_name" id="module_name" value="{{ old('module_name', $orderStatus->module_name) }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('online_payment') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="online_payment" id="online_payment" value="1" {{ $orderStatus->online_payment || old('online_payment', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('invoice') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="invoice" id="invoice" value="1" {{ $orderStatus->invoice || old('invoice', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('send_email') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="send_email" id="send_email" value="1" {{ $orderStatus->send_email || old('send_email', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('unremovable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="unremovable" id="unremovable" value="1" {{ $orderStatus->unremovable || old('unremovable', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('hidden') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="hidden" id="hidden" value="1" {{ $orderStatus->hidden || old('hidden', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('logable') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="logable" id="logable" value="1" {{ $orderStatus->logable || old('logable', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('delivery') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="delivery" id="delivery" value="1" {{ $orderStatus->delivery || old('delivery', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('shipped') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="shipped" id="shipped" value="1" {{ $orderStatus->shipped || old('shipped', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('paid') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="paid" id="paid" value="1" {{ $orderStatus->paid || old('paid', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pdf_invoice') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pdf_invoice" id="pdf_invoice" value="1" {{ $orderStatus->pdf_invoice || old('pdf_invoice', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('pdf_delivery') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="pdf_delivery" id="pdf_delivery" value="1" {{ $orderStatus->pdf_delivery || old('pdf_delivery', 0) === 1 ? 'checked' : '' }}>
