    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.banners.store") }}" enctype="multipart/form-data">
            ...
            {{-- <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('dis_index') ? 'is-invalid' : '' }}" type="number" name="dis_index" id="dis_index" value="{{ old('dis_index', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('display_text') ? 'is-invalid' : '' }}" type="text" name="display_text" id="display_text" value="{{ old('display_text', '') }}">
                ...
                <div class="form-group">
                    <label for="text-colour">{{ trans('cruds.banner.fields.text_colour') }}</label><br>
                      <input type="text" class="coloris instance2 form-control {{ $errors->has('text_colour') ? 'is-invalid' : '' }}" value="#cc458faa" name="text_colour" id="text_colour">
