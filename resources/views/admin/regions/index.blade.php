    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.regions.create') }}">
                {{ trans('global.add') }} Shipping Regions
            </a>
        </div>
    </div>
<div class="card">
    <div class="card-header">
       Shipping Regions {{ trans('global.list') }}
    </div>
                        ...
                        <tr data-entry-id="{{ $zipcode->id }}">
                            ...
                            <td>
                                <div class="text-nowrap text-theme-color">
                                    {{-- <a class="text-theme-color" href="{{ route('admin.regions.show', $zipcode->id) }}">
                                        <i class="fa-solid fa-eye"></i>
                                    </a> --}}

                                    <a class="text-theme-color" href="{{ route('admin.regions.edit', $zipcode->id) }}">
                                        <i class="fa-solid fa-pen-to-square"></i>
                                    </a>

                                    <form action="{{ route('admin.regions.destroy', $zipcode->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
