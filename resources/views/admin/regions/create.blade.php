    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.regions.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                type="text" name="region_name" id="region_name" value="{{ old('region_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('postcode') ? 'is-invalid' : '' }}" name="postcode[]" id="postcode" required multiple="multiple">
                    <option value="">Type to search postal codes...</option>
                    <!-- Initial postal codes loaded here -->
                    {{-- @foreach ($all_pincodes as $postcode)
