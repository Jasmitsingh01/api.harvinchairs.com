                    ...
                    <div class="col">
                        ...
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu" aria-labelledby="bulkActionsDropdown">
                                <a class="dropdown-item" href="#" data-action="delete" data-value="1">Delete
                                    Product</a>
                                <a class="dropdown-item" href="#" data-action="is_active" data-value="1">Active
                                    Product</a>
                                <a class="dropdown-item" href="#" data-action="is_active" data-value="0">Inactive
                                    Product</a>
                                <a class="dropdown-item" href="#" data-action="is_home" data-value="1">Enable Home</a>
                                <a class="dropdown-item" href="#" data-action="is_home" data-value="0">Disable
                                    Home</a>
                                <a class="dropdown-item" href="#" data-action="isFeatured" data-value="1">Enable
                                    Featured</a>
                                <a class="dropdown-item" href="#" data-action="isFeatured" data-value="0">Disable
                                    Featured</a>
                            </div>
                        </div>
                        @endcan
                        ...
                        <a href="{{ route('admin.product.import-product-status') }}" id="btnRemoveFilters" class="btn btn-primary">Import File Status</a>
                    </div>
                </div>

                <table id="datatable-Product" class=" table table-bordered datatable datatable-Product">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th width="10">
                                {{ trans('cruds.product.fields.reference_code') }}
                        ...
                        <tr class="search-row">
                            <th></th>
                            <th width="10">
                                <input class="search-input input-qty" id="product_id" type="text" placeholder="{{ trans('global.search') }}">
                            </th>
                            <th></th>
                            <th width="30">
                                <input class="search-input input-category" type="text" placeholder="{{ trans('global.search') }}">
                            </th>
                            <th width="10">
                                <input class="search-input  input-category" type="text" placeholder="{{ trans('global.search') }}">
                            </th>
                            ...
                            <th>
                                <input class="search-input input-qty" type="text" placeholder="{{ trans('global.search') }}">
                            </th>
                            <th>
                                <select class="search-input input-qty" strict="true">
                            ...
                            <th>
                                <select class="search-input input-category" strict="true">
                                    <option value>{{ trans('global.all') }}</option>
