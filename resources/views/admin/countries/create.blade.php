    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.countries.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shortname') ? 'is-invalid' : '' }}" type="text" name="shortname" id="shortname" value="{{ old('shortname', '') }}">
            ...
            <div class="form-group">
                <label for="zone_id">{{ trans('cruds.country.fields.zone') }} {{ trans('cruds.country.fields.name') }}</label>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phonecode') ? 'is-invalid' : '' }}" type="number" name="phonecode" id="phonecode" value="{{ old('phonecode', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('zip_code_format') ? 'is-invalid' : '' }}" type="text" name="zip_code_format" id="zip_code_format" value="{{ old('zip_code_format', '') }}">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('need_zip_code') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="need_zip_code" id="need_zip_code" value="1" {{ old('need_zip_code', 0) == 1 || old('need_zip_code') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('need_identification_number') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="need_identification_number" id="need_identification_number" value="1" {{ old('need_identification_number', 0) == 1 || old('need_identification_number') === null ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('contains_states') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="contains_states" id="contains_states" value="1" {{ old('contains_states', 0) == 1 || old('contains_states') === null ? 'checked' : '' }}>
