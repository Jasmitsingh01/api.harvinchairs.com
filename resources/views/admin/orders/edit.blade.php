    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.orders.update", [$order->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('customer_contact') ? 'is-invalid' : '' }}" type="text" name="customer_contact" id="customer_contact" value="{{ old('customer_contact', $order->customer_contact) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_tax') ? 'is-invalid' : '' }}" type="number" name="sales_tax" id="sales_tax" value="{{ old('sales_tax', $order->sales_tax) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('paid_total') ? 'is-invalid' : '' }}" type="number" name="paid_total" id="paid_total" value="{{ old('paid_total', $order->paid_total) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cancelled_amount') ? 'is-invalid' : '' }}" type="number" name="cancelled_amount" id="cancelled_amount" value="{{ old('cancelled_amount', $order->cancelled_amount) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('language') ? 'is-invalid' : '' }}" type="text" name="language" id="language" value="{{ old('language', $order->language) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('coupon') ? 'is-invalid' : '' }}" type="number" name="coupon" id="coupon" value="{{ old('coupon', $order->coupon) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('parent') ? 'is-invalid' : '' }}" type="number" name="parent" id="parent" value="{{ old('parent', $order->parent) }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('shop') ? 'is-invalid' : '' }}" name="shop_id" id="shop_id">
                    @foreach($shops as $id => $entry)
                        <option value="{{ $id }}" {{ (old('shop_id') ? old('shop_id') : $order->shop->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('shop'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('billing_address') ? 'is-invalid' : '' }}" name="billing_address" id="billing_address">{{ old('billing_address', $order->billing_address) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('logistics_provider') ? 'is-invalid' : '' }}" type="number" name="logistics_provider" id="logistics_provider" value="{{ old('logistics_provider', $order->logistics_provider) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_fee') ? 'is-invalid' : '' }}" type="number" name="delivery_fee" id="delivery_fee" value="{{ old('delivery_fee', $order->delivery_fee) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('delivery_time') ? 'is-invalid' : '' }}" type="text" name="delivery_time" id="delivery_time" value="{{ old('delivery_time', $order->delivery_time) }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Order::ORDER_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('order_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="order_status_{{ $key }}" name="order_status" value="{{ $key }}" {{ old('order_status', $order->order_status) === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Order::PAYMENT_STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('payment_status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="payment_status_{{ $key }}" name="payment_status" value="{{ $key }}" {{ old('payment_status', $order->payment_status) === (string) $key ? 'checked' : '' }}>
