    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.email-templates.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('template_code') ? 'is-invalid' : '' }}" type="text" name="template_code" id="template_code" value="{{ old('template_code', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('template_description') ? 'is-invalid' : '' }}" name="template_description" id="template_description">{{ old('template_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email_file_name') ? 'is-invalid' : '' }}" type="text" name="email_file_name" id="email_file_name" value="{{ old('email_file_name', '') }}">
