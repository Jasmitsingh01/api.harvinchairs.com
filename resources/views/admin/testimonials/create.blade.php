    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.testimonials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_name') ? 'is-invalid' : '' }}" type="text" name="author_name" id="author_name" value="{{ old('author_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('author_info') ? 'is-invalid' : '' }}" type="text" name="author_info" id="author_info" value="{{ old('author_info', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('content') ? 'is-invalid' : '' }}" type="text" name="content" id="content" required>{{ old('content', '') }}</textarea>
