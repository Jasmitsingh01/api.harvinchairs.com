    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-attributes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_code') ? 'is-invalid' : '' }}" type="text" name="reference_code" id="reference_code" value="{{ old('reference_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('minimum_quantity') ? 'is-invalid' : '' }}" type="number" name="minimum_quantity" id="minimum_quantity" value="{{ old('minimum_quantity', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bulk_buy_discount') ? 'is-invalid' : '' }}" type="number" name="bulk_buy_discount" id="bulk_buy_discount" value="{{ old('bulk_buy_discount', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('bulk_buy_minimum_quantity') ? 'is-invalid' : '' }}" type="number" name="bulk_buy_minimum_quantity" id="bulk_buy_minimum_quantity" value="{{ old('bulk_buy_minimum_quantity', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('availability_date') ? 'is-invalid' : '' }}" type="text" name="availability_date" id="availability_date" value="{{ old('availability_date') }}">
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ProductAttribute::IS_DEFAULT_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_default') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_default_{{ $key }}" name="is_default" value="{{ $key }}" {{ old('is_default', '0') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\ProductAttribute::IS_VISIBLE_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_visible') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_visible_{{ $key }}" name="is_visible" value="{{ $key }}" {{ old('is_visible', '1') === (string) $key ? 'checked' : '' }}>
