    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.carriers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reference_id') ? 'is-invalid' : '' }}" type="number" name="reference_id" id="reference_id" value="{{ old('reference_id', '') }}" step="1">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('shipping_handling') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="shipping_handling" id="shipping_handling" value="1" {{ old('shipping_handling', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('range_behavior') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="range_behavior" id="range_behavior" value="1" {{ old('range_behavior', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_module') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_module" id="is_module" value="1" {{ old('is_module', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('shipping_external') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="shipping_external" id="shipping_external" value="1" {{ old('shipping_external', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('need_range') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="need_range" id="need_range" value="1" {{ old('need_range', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('external_module_name') ? 'is-invalid' : '' }}" type="text" name="external_module_name" id="external_module_name" value="{{ old('external_module_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shipping_method') ? 'is-invalid' : '' }}" type="number" name="shipping_method" id="shipping_method" value="{{ old('shipping_method', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_width') ? 'is-invalid' : '' }}" type="number" name="max_width" id="max_width" value="{{ old('max_width', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_height') ? 'is-invalid' : '' }}" type="number" name="max_height" id="max_height" value="{{ old('max_height', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_depth') ? 'is-invalid' : '' }}" type="number" name="max_depth" id="max_depth" value="{{ old('max_depth', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_weight') ? 'is-invalid' : '' }}" type="number" name="max_weight" id="max_weight" value="{{ old('max_weight', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('grade') ? 'is-invalid' : '' }}" type="number" name="grade" id="grade" value="{{ old('grade', '') }}" step="1">
                @if($errors->has('grade'))
                    <div class="invalid-feedback">
                        {{ $errors->first('grade') }}
                    </div>
