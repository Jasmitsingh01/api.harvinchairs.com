            ...
            <div class="row" id="main-row">
                <div class="col-sm-3 cat-form @if (count($menus) == 0) disabled @endif">
                    ...
                    <div class="panel-group" id="menu-items">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading panel-div">
                                <a href="#static-pages-list" data-toggle="collapse" data-parent="#menu-items">Static Pages <span
                                        class="caret pull-right"></span></a>
                            </div>
                            <div class="panel-collapse collapse" id="static-pages-list">
                                <div class="panel-body">
                                    <div class="item-list-body">
                                        @foreach ($staticPages as $staticpage)
                                            <p><input type="checkbox" name="select-static-pages[]" value="{{ $staticpage->id }}">
                                                {{ $staticpage->name }}</p>
                                        @endforeach
                                    </div>
                                    <div class="item-list-footer">
                                        <label class="btn btn-sm btn-default"><input type="checkbox" id="select-all-static-pages">
                                            Select All</label>
                                        <button type="button" class="pull-right btn btn-default btn-sm" id="add-static-pages">Add
                                            to Menu</button>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="panel-collapse collapse" id="custom-links">
                                <div class="panel-body">
                                    <div class="item-list-body">
                                        ...
                                        <div class="form-group">
                                            <input type="checkbox" id="is_external" placeholder=""> <label>Is External Link</label>
                                        </div>
                                    </div>
                                    <div class="item-list-footer">
                ...
                <div class="col-sm-9 cat-view">
                    ...
                    @else
                        <div class="row">
                            <div class="col-sm-12">
                                <h3><span>Menu List</span></h3>
                                <select name="menulist" id="menulist" class="form-control">
                                    @foreach ($allMenus as $allmenu)
                                        <option value="{{ $allmenu->id }}" @if ($desiredMenu->id == $allmenu->id) selected @endif>{{ $allmenu->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <h3><span>{{$desiredMenu->title}} Structure</span></h3>
                        <div id="menu-content">
                            <div id="result"></div>
                                                                ...
                                                                {{-- @if ($item->type == 'custom') --}}
                                                                    ...
                                                                    <div class="form-group">
                                                                        <input type="checkbox" value="1"
                                                                            name="is_external"
                                                                            @if ($item->is_external == true) checked @endif>
                                                                        Is External Link
                                                                    </div>
                                                                    <div class="form-group">
                                                                                    ...
                                                                                    {{-- @if ($data->type == 'custom') --}}
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            <input type="checkbox"
                                                                                                ...
                                                                                                @if ($data->is_external == true) checked @endif>
                                                                                            Is External Link
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <input type="checkbox"
                                                                                            ...
                                                                                            <form method="post"
                                                                                                ...
                                                                                                {{-- @if ($data2->type == 'custom') --}}
                                                                                                    ...
                                                                                                    <div class="form-group">
                                                                                                        <input type="checkbox"
                                                                                                            name="is_external" value="1"
                                                                                                            @if ($data2->is_external == true) checked @endif>
                                                                                                        Is External Link
                                                                                                    </div>
                                                                                                    <div class="form-group">
                                                                                                        <input type="checkbox"
...
{{-- <script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js"></script> --}}
    ...
    <script>
        ...
        $('#select-all-static-pages').click(function(event) {
            if (this.checked) {
                $('#static-pages-list :checkbox').each(function() {
                    this.checked = true;
                });
            } else {
                $('#static-pages-list :checkbox').each(function() {
    ...
    <script>
        ...
        @if ($desiredMenu)
            ...
            $('#add-static-pages').click(function() {
                var menuid = {{ $desiredMenu->id }};
                var n = $('input[name="select-static-pages[]"]:checked').length;
                var array = $('input[name="select-static-pages[]"]:checked');
                var ids = [];
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.add-post-to-menu') }}",
                    success: function(res) {
                        location.reload();
                    },
                    error: function(xhr, status, error) {
            ...
            $("#add-custom-link").click(function() {
                ...
                var is_external = $('#is_external').is(':checked') ? 1 : 0;
        ...
        // menulist on change reload page  with selected menu
        $('#menulist').on('change', function() {
            var menuid = $(this).val();
            window.location.href = "{{ url('admin/menus') }}?id=" + menuid;
        });
    </script>
    <script>
