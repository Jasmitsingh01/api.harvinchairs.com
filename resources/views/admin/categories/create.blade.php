    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.categories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cgst_rate') ? 'is-invalid' : '' }}" type="number" name="cgst_rate" id="cgst_rate" value="{{ old('cgst_rate', '') }}" min=0 max=100>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sgst_rate') ? 'is-invalid' : '' }}" type="number" name="sgst_rate" id="sgst_rate" value="{{ old('sgst_rate', '') }}" min=0 max=100>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_home') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_home" id="is_home" value="1" {{ old('is_home', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('is_showcase') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="is_showcase" id="is_showcase" value="1" {{ old('is_showcase', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group" id="collection_image_div" style="display:none;">
