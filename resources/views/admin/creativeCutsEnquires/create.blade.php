...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.creativeCutsEnquire.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.creative-cuts-enquires.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('upload_file') ? 'is-invalid' : '' }}" type="text" name="upload_file" id="upload_file" value="{{ old('upload_file', '') }}">
