<table width="98%" border="0" cellspacing="0" cellpadding="5" align="center">
    <tbody>
        ...
        <tr>
            <td>We received your order and getting ready to be Delivered. Check out the details below.</td>
        </tr>
        <tr>
            <td></td>
        </tr>
