...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'namespace' => 'Admin', 'middleware' => ['auth']], function () {
    ...
    Route::post('categories/bulk-update', 'CategoriesController@bulkUpdate')->name('categories.bulkUpdate');
    Route::get('categories/search', 'CategoriesController@search')->name('categories.search');
    Route::get('categories/stats', 'CategoriesController@getCategoryStats')->name('categories.stats');
    Route::get('categories/export', 'CategoriesController@exportCategories')->name('categories.export');
    Route::post('categories/import', 'CategoriesController@importCategories')->name('categories.import');
    Route::get('categories/{category}/duplicate', 'CategoriesController@duplicate')->name('categories.duplicate');
    ...
    Route::patch('configurations/update',[ConfigurationController::class,'update'])->name('update-configuration');
     ...
     Route::delete('best-seller/destroy', 'BestSellerController@massDestroy')->name('best-seller.massDestroy');
     Route::post('best-seller/updateStatus', 'BestSellerController@updateStatus')->name('best-seller.updateStatus');
     Route::get('best-seller/search', 'BestSellerController@search')->name('best-seller.search');
