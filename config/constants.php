...
if (!defined('CHECK_INBOX_FOR_PASSWORD_RESET_EMAIL')) define('CHECK_INBOX_FOR_PASSWORD_RESET_EMAIL', 'Your Password reset link has been sent at your Email Address successfully!');
...
return [
'parent_id' => 0,
'FILESYSTEM_PATH' => env('FILESYSTEM_PATH','https://harvin.indapoint.org'),
'email_templates_path' => 'email_templates/',
'admin_email'=>env('ADMIN_EMAIL','jaapimail+harvin@gmail.com'),
'FILEMAXSIZE' => env('FILEMAXSIZE',10),
'FILEWIDTH' => env('FILEWIDTH',4096),
'FILEHEIGHT' => env('FILEHEIGHT',4096),
'WEB_APP_URL' => env('WEB_APP_URL',''),
'PRODUCT_SLUG_NAME' => env('PRODUCT_SLUG_NAME','products'),
'CATEGORY_SLUG_NAME' => env('CATEGORY_SLUG_NAME','categories'),
'BLOG_SLUG_NAME' => env('BLOG_SLUG_NAME','cms'),
'SEARCH_RESULT_LIMIT' => env('SEARCH_RESULT_LIMIT',10),
'HELPDESK_EMAIL_RECEIVER' => env('HELPDESK_EMAIL_RECEIVER','admin@gmail.com'),
'ALLOW_ORDER_CANCEL_DAYS' => env('ALLOW_ORDER_CANCEL_DAYS',300),
];
